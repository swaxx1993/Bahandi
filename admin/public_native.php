...
<ul id="nav"> 
	...
	<li><a href="public_handicraft.php" >Handicrafts</a></li>
   	<li><a href="#" class="currentview">Native Delicacies</a></li>
...
<?php
	...
	$query="select * from adminproduct where category='native delicacies' ORDER by id DESC";
