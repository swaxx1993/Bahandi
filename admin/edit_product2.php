...
<form id="form1" method="post" action="editproccess_product2.php" enctype="multipart/form-data" onSubmit="return validate()">
<div id="uploadphoto">
 <table align="center" >
	  <tr>
      <td>&nbsp;</td>
...
<form  action="editproccess_product2.php" method="post">
...
<br><br><font color="#999999" class="fontstyle">Enter SRP:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="srp" class="text" value="<?php echo $row ['srp']; ?>" disabled="disabled" required="required"/>
<br><br><font color="#999999" class="fontstyle">Quantity:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="quantity" class="text" value="<?php echo $row ['quantity']; ?>"  required="required"/>
<br><br><input type="submit" value="Update" class="button"><input type='button' value='Back' onClick=window.location.href='supplier_monitor.php' class="button">
</b>
</form>
