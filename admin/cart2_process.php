...
if (isset($_POST['submit'])){ 
		...
		if($_POST['quantity'] < $_POST['item']){
			echo "<script type='text/javascript'>alert('Quantity not allowed..');location='handicraft.php';</script>";
		}else
		{
			include('connection.php');
			...
			echo "<script type='text/javascript'>alert('Item added to cart');location='handicraft.php';</script>";
			  include('connection.php');
			  mysql_close($connect); 
}
